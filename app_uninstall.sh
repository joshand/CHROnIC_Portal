...
echo "Uninstalling the app at imapex/chronic/portal"
curl -k -X DELETE -u $mantl_user:$mantl_password https://$control_address:8080/v2/apps/imapex/chronic/portal \
